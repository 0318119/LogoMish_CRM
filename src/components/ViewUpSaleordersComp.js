...
import '../components/assets/css/Upsales.css'
...
function ViewUpSaleordersComp() {
        ...
        await fetch(`${config['baseUrl']}/sales/GetUpSales/${parseInt(page)}`, {
            ...
            if (response.messsage == "unauthorized") {
                await fetch(`${config['baseUrl']}/sales/GetUpSales/${parseInt(page)}`, {
                    ...
                    setRows(response.data.filter(data => data.email == emails).length)
                    setDataLoader(true)
                }).catch((errs) => {
    ...
    const handlePrint = useReactToPrint({
      ...
      documentTitle:"VIEW UP SALES DETAILS",
      pageStyle:"print",
    });
    ...
    return (
        <>
            <div className="frontSalesBox">
                <h4 className='frontSalesBoxHeadOne'>Up sales Details</h4>
                <div className="innerfrontSalesBox">
                    ...
                    <h4 className='frontSalesBoxHeadTwo'>Up sales Details</h4>
                    <SearchBar
...
export default ViewUpSaleordersComp