...
function FronSaleCom() {
    ...
    async function getOrders() {
        await fetch(`${config['baseUrl']}/sales/GetFrontSales/${parseInt(page)}`, {
            method: "GET",
    ...
    const columns = [
        ...
        },
        {
            ...
            selector: (row) =>
            <div className='dataTableIconBox'>
                <Link to={`/ViewFrontSaleOrder?email=${row.email}`} target='_blank' className='mt-2'>
                    <span><View_ico className='OrderViewIco'/></span>
                </Link>
                <Tooltip
                    anchorSelect=".row-View_ico"
                    place="bottom"
                    content="View Front Sales"
                />
            </div>
        },
        {
    ...
    return (
        <>
            <div className="customersList">
                <h4 className='customersListHeadOne'>Front Sales</h4> 
                <div className="innerCusListBox">
                    ...
                    <h4 className='customersListHeadTwo'>Front Sales</h4> 
                    <SearchBar 
