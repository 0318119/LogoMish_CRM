...
function GetLeadsByPerWeakChart() {
    ...
    async function getLeadByPerWeak() {
        await fetch(`${config['baseUrl']}/lead/GetCustomerLeadsByWeek`, {
            method: "GET",
                   ...
                   {dataLoader && (
                    <>
                         <div className="earningPerDayBox">
                            <h3>569</h3>
                            <span>Get Leads By Per Weak</span>
                        </div>
...
export default GetLeadsByPerWeakChart